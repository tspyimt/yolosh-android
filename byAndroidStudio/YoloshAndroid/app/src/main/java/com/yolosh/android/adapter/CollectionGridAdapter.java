...
//import com.yolosh.android.model.*;
//
///**
...
//	private List<CollectionGroup> dataList = new ArrayList<CollectionGroup>();
//
//	public CollectionGridAdapter(Context c, List<CollectionGroup> dataset) {
//		mContext = c;
//		dataList = dataset;
//	}
//
...
//			textView1.setText(dataList.get(position).getStartNumber());
//			textView2.setText(dataList.get(position).getStartNumber());
//		} else {
